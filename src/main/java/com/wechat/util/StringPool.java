 ...
 * @Copy Right:www.easou.com
 * @System:www.easou.com
 * @Create Time:2007-9-22
 * @Package com.easou.core.util.helper.StringPool.java
 * @Description:常量
 */
public class StringPool {
	...
	public static final String LOGIN_TYPE_DIRECT="LOGIN_DIRECT";
	public final static String LOGIN_TYPE_COOKIE="LOGIN_BY_COOKIE";
	...
	public static Map getSecurityResourceType() {
		if (SECURITY_RESOURCE_TYPE.isEmpty()) {
			...
			SECURITY_RESOURCE_TYPE
					.put(SECURITY_RESOURCE_TYPE_COMPONENTS, "component");
			SECURITY_RESOURCE_TYPE.put(SECURITY_RESOURCE_TYPE_FUNCTION, "function");
		}
	 ...
	 */
	//注册用户角色ID
	public static final String SECURITY_REGISTER_ROLE_ID="2";
	//管理员角色ID
	public static final String SECURITY_ADMINISTRATOR_ROLE_ID="1";
	 ...
	 * portal
	 */
	public static final String PORTAL_DEFAULT_PORTAL_NAME="Home";
	public static final String PORTAL_DEFAULT_USER_DEFINE_PORTAL_NAME="Defaut New Label";
...
//	public static final String TREE_CLS = "cls";
	...
	public static final String TREE_LINK = "link";
...
//	public static final String TREE_ID = "id";
	...
	public static final String TREE_CHECKED="checked";
...
//	public static final String TREE_ROOT_ID = "root";
	...
	public static final String DEPLOY_TEST="test";
	public static final String DEPLOY_PRODUCT="product";
