...
public interface LessonService {
	...
	Page<ClassCourse> findClassCourses(HashMap<String, String> map);
	...
	JSONArray findClassStudentsRecordByClassGradesId(
			HashMap<String, String> map);
	...
	JSONArray getClassCourseComment(Integer integer);
	...
	Object getClassCourseCommentById(Integer id);
	...
	StdDiyStudyDay getStdDiyStudyDay(int parseInt);
