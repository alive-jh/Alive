...
public interface BookService {
	...
	List getBookCategoryNolevel(String string, int i, int j, int currentId,
                                ArrayList arrayList);
	
	List getBookCategoryList(int parentId, int level,
                             ArrayList cats);

	void deleteBookCategory(int catId);


	String getCategoryChildIds(String string, int catId);
