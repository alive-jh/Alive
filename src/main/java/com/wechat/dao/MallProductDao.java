...
public interface MallProductDao {
		 ...
		 * @return
		 */
		 List searchCity(String provinceId);
		/**
		 * 查询收货地址列表
		 * @param memberId
		 * @return
		 */
		 List searchUserAddress(String memberId);
		/**
		 * 保存会员收货地址
		 * @param userAddress
		 */
		 ...
		 * @param memberId
		 */
		 void updateAddressStatus(String id, String memberId);
		 ...
		 * @return
		 */
		 UserAddress getUserAddressBystatus(Integer memberId);
		 ...
		 */
		 void saveMallOrderProduct(MallOrderProduct mallOrderProduct);
		 ...
		 * @return
		 */
		 List searchMallOrderProduct(String orderId);
		 ...
		 * @return
		 */
		 List searchShoppingCart(String memberId);
		 ...
		 * @param count
		 */
		 void updateCount(String id, String count);
		 ...
		 * @return
		 */
		 HashMap searchMallProductMap(String ids);
		 ...
		 * @return
		 */
		 List searchMallOrderByMemberId(String memberId);
		 ...
		 * @return
		 */
		 List searchMallOrderProductByMemberId(String orderId);
		
		/**
		 * 查询商品列表
		 */
		 List searchMallProductList(String productId);
		 ...
		 * @return
		 */
		 List searchMemberOrder(HashMap map);
		 ...
		 * @return
		 */
		 Page searchMallOrderInfo(HashMap map);
		 ...
		 * @param express
		 */
		 void updateMallOrderStatus(String id, Integer operatorId, String express);
