...
public class TestOldData101 extends AbstractData {
	...
	public ClassCourseSchedule getClassCourseSchedule(int studentId, int classGradeId) {
		...
		ccs.setClassCourseId(ClassCourseSchedule.TAG_FINISH);//TODO
		ccs.setClassRoomId(-1);//TODO
		ccs.setDoDay(1);//TODO
		ccs.setLastTime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()));
		return ccs;
	}
...
//			log += " classGradesId ";
//		}
		if (classCourseId != ClassCourseSchedule.TAG_FINISH) {//TODO
			log += " classCourseId ";
		}
