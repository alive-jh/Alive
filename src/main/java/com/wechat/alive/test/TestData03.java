...
public class TestData03 extends AbstractData {
	...
	public ClassCourseSchedule getClassCourseSchedule(int studentId, int classGradeId) {
		...
		ccs.setClassCourseId(2);//TODO
		ccs.setClassRoomId(113);//TODO
		ccs.setDoDay(1);//TODO
		ccs.setLastTime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()));//TODO
		return ccs;
	}
...
//			log += " classGradesId ";
//		}
		if (classCourseId != 2) {//TODO
			log += " classCourseId ";
		}
		if (classRoomId != 113) {//TODO
			log += " classRoomId ";
		}
		if (doDay != 1) {//TODO
			log += " doDay ";
...
//		}
	...
	@Override
	public void noChange(String log) {//TODO
		if (log.equals(AliveProgress.ALREADY_UPDATE_TODAY)) {//TODO
			log = "Match: " + log;
		} else {
			log = "Not Match: " + log;
		}
