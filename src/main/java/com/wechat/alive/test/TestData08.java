...
public class TestData08 extends Test.AbstractData {
	...
	public ClassCourseSchedule getClassCourseSchedule(int studentId, int classGradeId) {
		...
		ccs.setClassCourseId(8);//TODO
		ccs.setClassRoomId(133);//TODO
		ccs.setDoDay(1);//TODO
		return ccs;
	}
...
//			log += " classGradesId ";
//		}
		if (classCourseId != 8) {//TODO
			log += " classCourseId ";
		}
		if (classRoomId != 133) {//TODO
			log += " classRoomId ";
		}
		if (doDay != 3) {//TODO
			log += " doDay ";
...
//		}
	...
	private List<ClassCourse.Course> getCourseList(int classGradeId, int startDoDay) {
		List<ClassCourse.Course> courseList = new ArrayList<ClassCourse.Course>();
...
//		courseList.add(getCourse(6, "��-02-��", 500, 2, 125, classGradeId));
	...
	private ClassCourse.Course getCourse(int id, String doTitle, int doSlot, int doDay,
                                         int classRoomId, int classGradesId) {
		return new ClassCourse.Course(id, doTitle, doSlot, doDay, classRoomId, classGradesId);
	}
