 ...
 */
@Entity
@Table(name = "class_room", catalog = "wechat")
public class ClassRoom implements java.io.Serializable {
	...
	/** full constructor */
	public ClassRoom(Integer teacherId, String teacherName, String className,
			String cover, String summary, Integer status, Integer sort,
			Integer categoryId, Integer bookResId, String groupId,
			Timestamp createTime,String bookResIds) {
	...
	@Column(name = "book_res_ids")
	public String getBookResIds() {
		return this.bookResIds;
	}
