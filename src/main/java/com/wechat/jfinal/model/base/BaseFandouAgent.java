...
public abstract class BaseFandouAgent<M extends BaseFandouAgent<M>> extends Model<M> implements IBean {
	...
	public M setTopAgentId(java.lang.Integer topAgentId) {
		set("top_agent_id", topAgentId);
		return (M)this;
	}

	public java.lang.Integer getTopAgentId() {
		return getInt("top_agent_id");
	}
