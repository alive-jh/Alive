...
public abstract class BaseLessonReplyComment<M extends BaseLessonReplyComment<M>> extends Model<M> implements IBean {
	...
	public M setScriptId(java.lang.Integer scriptId) {
		set("script_id", scriptId);
		return (M)this;
	}

	public java.lang.Integer getScriptId() {
		return getInt("script_id");
	}
