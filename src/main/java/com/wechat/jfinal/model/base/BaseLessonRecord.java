...
public abstract class BaseLessonRecord<M extends BaseLessonRecord<M>> extends Model<M> implements IBean {
	...
	public M setLessonReplyContent(java.lang.String lessonReplyContent) {
		set("lesson_reply_content", lessonReplyContent);
		return (M)this;
	}

	public java.lang.String getLessonReplyContent() {
		return getStr("lesson_reply_content");
	}
