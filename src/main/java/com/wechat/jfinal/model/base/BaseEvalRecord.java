...
public abstract class BaseEvalRecord<M extends BaseEvalRecord<M>> extends Model<M> implements IBean {
	...
	public M setIsRight(java.lang.Integer isRight) {
		set("is_right", isRight);
		return (M)this;
	}

	public java.lang.Integer getIsRight() {
		return getInt("is_right");
	}
