...
public abstract class BaseGradeStudyDayByDay<M extends BaseGradeStudyDayByDay<M>> extends Model<M> implements IBean {
	...
	public M setDayStr(java.lang.String dayStr) {
		set("day_str", dayStr);
		return (M)this;
	}

	public java.lang.String getDayStr() {
		return getStr("day_str");
	}
