		...
		<div class="content">
			...
			<div class="content-body">
				...
				<div class="time-addr">
					...
					<ul>
						<li>
							<a id="timer-sbox" class="clearfix" href="#">
								<i class="input-icon time"></i>
								<span>服务时间:</span>
								<p class="time-btn"><span class="time-show" ><b></b><i>${orderDate}</i></span></p>
								<b class="arrow"></b>
							</a>
						</li>
						<li>
			...
			<div class="control-btn fixed-block">
				<input type="button" value="拨打客户电话" onclick="toMobile('tel:${userAddress.mobile}')"/>
			</div>
			<!--提交按钮结束-->
