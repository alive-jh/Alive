...
function updateUI(){
	...
	for(var i=0;i<jsonData.length;i++){
			...
			newcontent = newcontent + '<td nowrap="nowrap" align="left" >'+jsonData[i].question+'</td>';

			newcontent = newcontent + '<td nowrap="nowrap" align="left" >'+jsonData[i].insertDate+'</td>';
			newcontent = newcontent + '<td nowrap="nowrap" align="left" ><button class="btn btn-xs btn-info"  onclick="editData('+i+')" data-toggle="modal" data-target="#myModal-data">问题编辑</button>';
			newcontent = newcontent + '&nbsp;&nbsp;<button class="btn btn-xs btn-info"  onclick="showAnswer('+i+')" data-toggle="modal" data-target="#answer-data">编辑答案</button>';
			newcontent = newcontent + '&nbsp;&nbsp;<button class="btn btn-xs btn-info"  onclick="deleteQuestion('+i+')" data-toggle="modal" data-target="#answer-data">删除问题</button></td>';
			newcontent = newcontent + '</tr>';
	}
