...
function updateUI(){
	...
	for(var i=0;i<jsonData.length;i++){
			...
			newcontent = newcontent + '<td nowrap="nowrap" align="left" >'+jsonData[i].password+'</td>';
			...
			newcontent = newcontent + '&nbsp;&nbsp;<button class="btn btn-xs btn-info"  onclick="deleteQuestion('+i+')" data-toggle="modal" data-target="#answer-data">老师管理</button>';
			newcontent = newcontent + '&nbsp;&nbsp;<button class="btn btn-xs btn-info"  onclick="deleteQuestion('+i+')" data-toggle="modal" data-target="#answer-data">删除用户</button></td>';
			newcontent = newcontent + '</tr>';
	}
