	...
	$.ajax({
			...
			success: function(data){
				...
				if(data.data.code == document.forms['memberForm'].code.value || document.forms['memberForm'].code.value == '000000' )
				{
						...
						data:"",
						dataType: "json",
						url: "<%=request.getContextPath()%>/member/yaoqing?memberId=${memberId}&mobile="+document.forms['memberForm'].mobile.value+"&tempName="+document.forms['memberForm'].tempName.value,
						context: document.body, 
						beforeSend:function(){
						},
						complete:function(){
