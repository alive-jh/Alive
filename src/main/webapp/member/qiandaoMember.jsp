...
function saveMember()
{
	...
	var tempName = document.forms['memberForm'].tempName.value;
	if(tempName =='')
	{
		alert("请输入名称!");
		return;
	...
	$.ajax({
			...
			success: function(data){
				...
				if(data.data.code == document.forms['memberForm'].code.value || document.forms['memberForm'].code.value == '000000' )
				{
						...
						data:"",
						dataType: "json",
						url: "<%=request.getContextPath()%>/member/qiandao?memberId=${memberId}&mobile="+document.forms['memberForm'].mobile.value+"&tempName="+document.forms['memberForm'].tempName.value+"&age="+document.forms['memberForm'].age.value,
						context: document.body, 
						beforeSend:function(){
						},
						complete:function(){
			...
			<div class="content-body">
				...
				<input type="hidden" name="memberId" value="${memberId}">
					...
					<div class="input-block">
							<span class="input-icon usr"></span>
							<input  type="text" name="tempName" placeholder="名称"/>
						</div>
						...
						<div class="input-block">
							<span class="input-icon addr"></span>
							<input  type="text" name="age" placeholder="小孩年龄"/>
						</div>
						<div class="input-block">
					...
					<div class="post-btn clearfix">
						...
						<input type="button" value="签 到" onclick="saveMember()" class="acitve"/>
					</div>
				</form>
