...
<html>
    ...
    jsApiList: [  'checkJsApi',
            ...
            'getNetworkType'
				...
				$(function() {
					//默认选中第一项
						$('#shop-size li').eq(0).addClass('active');
						checkType(0);
						var $ul = $('ul');
			...
			function saveShoppingCart()
			{
					...
					if(tempMemberId == '')
					{
						...
						document.forms['mallForm'].action = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxbeda1313a1604ddf&redirect_uri=http://wechat.fandoutech.com.cn/wechat/oauth2Servlet&response_type=code&scope=snsapi_userinfo&state=toProductView@${tempProduct[0]}#wechat_redirect";
						document.forms['mallForm'].submit();
					}
					else
				    {
			...
			<div class="shop-box" id="shop-box">
				<div class="shop-message">
					<div class="shop-header">
						<img class="goods-img" src="${tempProduct[2]}" />
