		...
		<div class="container">
			...
			<div class="content">
				<div class="content-body">
					...
					<br/>
					<% int i=0;%>
					<c:forEach items="${mallList}" var="mallInfo">
						<a class="book-cake" href="javascript:void(0);">${mallInfo.title}</a>
						<!--产品图片开始-->
						<ul class="goods-list clearfix">

						
						<c:forEach items="${mallInfo.mallProductList}" var="product">
								<li class="goods-card">
									<a class="goods clearfix" href="<%=request.getContextPath() %>/mall/mallMobileManager?mallProductId=${product[0]}&memberId=${memberId}" title="${product[1]}">
										<div class="photo-block">
											<img class="goods-photo" src="${product[2]}" />       
										</div>
