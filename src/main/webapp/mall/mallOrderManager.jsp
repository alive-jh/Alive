...
function updateMallOrderStatus()
{
	...
	document.forms['materialForm'].action = "<%=request.getContextPath()%>/mall/updateStatus";
...
<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header col-xs-12" style="float: left;width:100%">
							<form class="form-inline" role="form" method="post"  name="searchForm" action="<%=request.getContextPath()%>/mall/mallOrderManager" style="float: left;width:100%">
						...
						<f:page page="${resultPage}" url="./mallOrderManager" params="<%=request.getParameterMap()%>" />
										...
										<label class="col-sm-2 control-label no-padding-right text-right">买家留言</label>
											...
											<div class="input-medium">
												<div class="input-group">
													...
													<textarea id = "remarks" name ="content" style="width:650px;height:150px;" ></textarea>
							...
							<div class="form-group" style="height:35px;">
								...
								<div class="form-group" style="height:35px;" style="width:710px;">
									<label class="col-xs-3 control-label no-padding-right text-right">收货地址</label>
										...
										<div class="input-medium">
											<div class="input-group" style="width:710px;">
												<textarea id="remarks" name="address" style="max-width:350px;height:80px;"></textarea>
												<!-- 
