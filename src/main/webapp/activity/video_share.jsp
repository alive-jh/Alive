...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/activity/css/comment.css">
...
<div class="container-fluidcontainer-fluid" >
    ...
    <div class="title">
        <h4>${video[23]}的学习视频&nbsp;&nbsp;&nbsp;&nbsp;${gradeName }</h4>
    ...
    <div class="content1">
        <div class="text1"><i class="glyphicon glyphicon-eye-open" style="color:black;font-size: 15px"></i>&nbsp;<span>观看次数:${video[14]+1}</span></div>
        <div class="text1" onclick="addlike(this);"><i class="glyphicon glyphicon-heart" style="color: red"></i> 点赞：<a href="javascript:;">${video[16]}</a></div>
        <!-- <div class="text1"><a href="javascript:$('#payPanle').toggle();" ><i class="glyphicon glyphicon-education"></i> 鼓励一下</a> -->
        </div>
    </div>
</div>
<div id="payPanle" style="display: none">
<div class="acknowledge-li clearfix">
            <a class="acknowledge-list" href="javascript:get_price(0.88);" data-price="0.88" id="p1">
                <div class="img">
                    <img src="<%=request.getContextPath() %>/activity/images/002.png" alt="">
                </div>
                <p>送铅笔</p>
                <i class="yuan">¥&nbsp;0.88</i>
            </a>
            <a class="acknowledge-list" href="javascript:get_price(1.88);" data-price="1.88" id="p2">
                <div class="img">
                    <img src="<%=request.getContextPath() %>/activity/images/001.png" alt="">
                </div>
                <p>送笔记本</p>
                <i class="yuan">¥&nbsp;1.88</i>
            </a>
            <a class="acknowledge-list" href="javascript:get_price(5.20);" data-price="5.20" id="p3">
                <div class="img">
                    <img src="<%=request.getContextPath() %>/activity/images/004.png" alt="">
                </div>
                <p>送文具盒</p>
                <i class="yuan">¥&nbsp;5.20</i>
            </a>
            <a class="acknowledge-list" href="javascript:get_price(8.88);" data-price="8.88" id="p4">
                <div class="img">
                    <img src="<%=request.getContextPath() %>/activity/images/003.png" alt="">
                </div>
                <p>送书包</p>
                <i class="yuan">¥&nbsp;8.88</i>
            </a>
        </div>
        <div style="width: 100%;text-align: center;color: red;line-height: 30px" onclick="get_price(null)">其他金额</div>
</div>
...
<div class="commentAll">
    ...
    <div class="reviewArea clearfix">
        <textarea id="pinglun" name="pinglun" class="content comment-input" placeholder="来发表一下评论吧&hellip;" onkeyup="keyUP(this)"></textarea>
        <p><span class="emotion"><img id="iconn1" src="http://p0a08uq9q.bkt.clouddn.com/biaoqingicon.png"></span></p>
        <div id= "top111" style="width: 100%;height: 130px;display: none"></div>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/qqFace/js/jquery.qqFace.js"></script>
<script type="text/javascript">
...
$(function(){
	...
	$('.emotion').qqFace({
		...
		path:'<%=request.getContextPath() %>/qqFace/arclist/'	//表情存放的路径
...
function replace_em(str){
	...
	str = str.replace(/\[em_([0-9]*)\]/g,'<img src="${pageContext.request.contextPath}/qqFace/arclist/$1.gif" border="0" />');
