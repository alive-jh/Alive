...
function categorySelect(flag,index){
	...
	if(flag){
		...
		//修改
		$("#catId option").remove();
		if(data.infoList[index].catId==0){
		...
		for(var i=0;i<catData.infoList.length;i++){
			if(catData.infoList[i].cat_id==data.infoList[index].catId){
...
function deleteArticle(index){
	...
	{
		document.forms['addarticle'].action ="removeMallSpecial?specialId="+data.infoList[index].id+"&topicType="+topicType;
		document.forms['addarticle'].submit();
	}
}
...
function updateSpecialSort(index,type)
{
	...
	document.forms['addarticle'].action = "./updateSpecialMallSort?specialId="+data.infoList[index].id+"&tempSort="+data.infoList[index].sort+"&type="+type+"&topicType="+topicType;
	document.forms['addarticle'].submit();
}
function updateSpecialStatus(index,status)
{
	document.forms['addarticle'].action = "./updateSpecialMallStatus?specialId="+data.infoList[index].id+"&tempStatus="+status+"&topicType="+topicType;
	document.forms['addarticle'].submit();
}
...
<div class="main-content">
			...
			<!-- 模态弹出窗内容 -->
			 <form class="article" method="post" name="addarticle" enctype="multipart/form-data" action ="<%=request.getContextPath()%>/special/saveMallSpecial">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div  id="divAccount" class="form-group" style="height:35px;">
								<label class="col-sm-2 control-label no-padding-right text-right">专题名称</label>
										<div class="col-sm-9">
							...
							<div class="form-group" id="picLogo"style="height:100px;">
									...
									<div  id="divAccount" class="form-group" style="height:35px;">
									<label class="col-sm-2 control-label no-padding-right text-right">展示分类</label>
											<div class="col-sm-9">
												<div class="input-medium" >
													<div class="input-group" style="width:910px;">
