...
<html>
	...
	<body>
        ...
        <div class="other-box like-box" id="bookList" style="padding-top:46px;">
            <div class="swiper-object">
                <ul class="book-list clearfix">
					...
					<c:forEach items="${tempList}" var="tempBook">
                    <li class="list-info" data-id="${tempBook[6]}">
                        <a href="javascript:void(0);" class="clearfix">
                            <div class="check-group">
                             ...
                             <b class="list-num"></b>
                            <img src="<%=request.getContextPath()%>/wechatImages/book/${tempBook[2]}"/>
                            <div class="info-box">
                                <h3 class="book-name">${tempBook[1]}</h3>
                                
                                <p class="author-name">${tempBook[5]}</p>
                                ...
                                <div class="book-short">${tempBook[3]}</div>
                                <p class="price">￥<span>${tempBook[4]}</span></p>
        ...
        <div class="submit-group">
            ...
            <button class="footer-center-btn delete" id="orderEdit" onclick="deleteShoppingCart()">编辑</button>
            <button class="price-info" onclick="saveOrder()">
              去结算<b>(<span class="total-price">0</span>元)</b>
            </button>
        </div>
        <!--submit-group-end-->
