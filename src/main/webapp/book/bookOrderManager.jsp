...
<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header col-xs-12" style="float: left;width:100%">
							<form class="form-inline" role="form" method="post"  name="searchForm" action="<%=request.getContextPath()%>/book/bookOrderManager" style="float: left;width:100%">
						...
						<f:page page="${resultPage}" url="./bookOrderManager" params="<%=request.getParameterMap()%>" />
