...
function updateMallLabel()
{
	...
	document.forms['searchForm'].action ="updateBookLabel?id="+document.forms['searchForm'].id.value;
...
function deleteUser(index){
	...
	{
		document.forms['searchForm'].action ="deleteBookLabel?id="+data.infoList[index].id;
		document.forms['searchForm'].submit();
	}
}
...
function setItems()
{
	...
	document.forms['searchForm'].action = "./saveBookLabel";
	document.forms['searchForm'].submit();
...
<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header col-xs-12" style="float: left;width:100%">
							<form class="form-inline" role="form" method="post" name="searchForm" action="<%=request.getContextPath()%>/mall/bookLabelManager" style="float: left;width:100%">
							<input type="hidden" name="labelId">
							<input type="hidden" name="id">
							<input type="hidden" name="tempLabelIds" value="${labelIds}">
						...
						<div class="row">
							...
							<f:page page="${resultPage}" url="./bookLabelManager" params="<%=request.getParameterMap()%>" />
